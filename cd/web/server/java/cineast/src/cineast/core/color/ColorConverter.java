...
//	}
	...
	public static RGBContainer HSVtoRGB(ReadableHSVContainer hsv){
		...
		if(hsv.s < 0.00001f){
			...
			switch(i){
			case 0:{r = (int) (255f * hsv.v); g = v3; b = v1; break;}
			case 1:{r = v2; g = (int) (255f * hsv.v); b = v1; break;}
			case 2:{r = v1; g = (int) (255f * hsv.v); b = v3; break;}
			case 3:{r = v1; g = v2; b = (int) (hsv.v * 255f); break;}
			case 4:{r = v3; g = v1; b = (int) (hsv.v * 255f); break;}
			default:{r = (int) (255f * hsv.v); g = v1; b = v2; break;}
			}
		}
		return new RGBContainer(r, g, b);
	}
	...
	private static TIntObjectHashMap<ReadableLabContainer> rgbToLabCache = new TIntObjectHashMap<ReadableLabContainer>(100000);
	

	public static synchronized ReadableLabContainer cachedRGBtoLab(int rgb){
		synchronized(rgbToLabCache){
